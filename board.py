...
class Board:
    ...
    def render(self, score, nodes, time, mode):
        ...
        print()
        print("Le score pour le joueur humain est", score_text, ",", nodes, "positions analysées en", round(time,2), "secondes")
